...
export function Plugins({
  ...
  return (
    <div className="relative">
      <ToolbarPlugin>
        {({ blockType }) => (
          <div className="vertical-align-middle sticky top-0 z-10 flex flex-wrap items-center gap-1 sm:gap-2 overflow-hidden lg:overflow-auto border-b p-1 sm:p-2 bg-background">
            {/* Primary toolbar row - always visible */}
            <div className="flex w-full flex-wrap items-center gap-1 sm:gap-2">
              <HistoryToolbarPlugin />
              <Separator
                orientation="vertical"
                className="!h-5 sm:!h-7 hidden sm:block"
              />
              <BlockFormatDropDown>
                <FormatParagraph />
              ...
              {blockType === "code" ? (
                ...
                <>
                  {/* Desktop: Show all tools in one row */}
                  ...
                  {/* Mobile/Tablet: Split into multiple rows */}
                  <div className="flex lg:hidden w-full flex-col gap-1">
                    {/* Row 1: Font controls */}
            ...
            <div className="">
              <div className="" ref={onRef}>
                <ContentEditable
                  ...
                  className="ContentEditable__root relative block min-h-[300px] sm:min-h-[400px] lg:min-h-100 max-h-[500px] sm:max-h-[600px] lg:max-h-140 overflow-auto px-3 py-3 sm:px-6 sm:py-4 lg:px-8 focus:outline-none text-sm sm:text-base"
                />
              </div>
            </div>
          }
      ...
      <ActionsPlugin>
        <div className="clear-both flex flex-col sm:flex-row items-center justify-between gap-2 overflow-auto border-t p-2 sm:p-1 bg-background">
          {/* Mobile: Stack vertically */}
          <div className="flex w-full sm:w-auto flex-1 justify-start items-center gap-2 order-2 sm:order-1">
          ...
          {/* <div className="flex w-full sm:w-auto flex-1 justify-end items-center gap-1 flex-wrap order-3">
            <SpeechToTextPlugin />
            <ShareContentPlugin />
            <ImportExportPlugin />
