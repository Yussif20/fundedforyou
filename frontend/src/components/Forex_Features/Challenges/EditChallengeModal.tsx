...
export default function EditChallengeModal({
  ...
  useEffect(() => {
    if (singleData) {
      ...
      reset({
        ...
        maxLeverage: rest.maxLeverage ?? "",
        activationFees: rest.activationFees?.toString() ?? "",
        contractSizeMini: rest.contractSizeMini != null ? rest.contractSizeMini.toString() : "",
        contractSizeMicro: rest.contractSizeMicro != null ? rest.contractSizeMicro.toString() : "",
        consistencyRuleChallenge: rest.consistencyRuleChallenge != null ? rest.consistencyRuleChallenge.toString() : "",
        consistencyRuleFunded: rest.consistencyRuleFunded != null ? rest.consistencyRuleFunded.toString() : "",
        payoutFrequency: rest.payoutFrequency ?? "",
        payoutFrequencyArabic: rest.payoutFrequencyArabic ?? "",
  ...
  const onSubmit = async (data: any) => {
    const payload = {
      ...
      challengeNameId: data.challengeNameId || null,
      ...
      maxLostType: data.maxLostType || null,
      profitSplit: Number(data.profitSplit),
      payoutFrequency: data.payoutFrequency,
      payoutFrequencyArabic: data.payoutFrequencyArabic,
      ...
      overnightHolding: data.overnightHolding,
      stopLossRequired: data.stopLossRequired,
