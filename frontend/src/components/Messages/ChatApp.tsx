...
export default function ChatApp() {
  ...
  return (
    <Container className="flex h-[80vh] pb-20">
      <div
        style={{ boxShadow: "0px 0px 16px 0px rgba(37, 99, 235, 0.1)" }}
        className="flex w-full h-full bg-foreground rounded-lg overflow-hidden"
      >
        <div
          className={`h-full w-full md:w-105 bg-foreground ${
          ...
          <div className="flex-1 flex items-center justify-center bg-gray-50 border-l border-gray-200">
            <div className="text-center px-6">
              ...
              <p className="text-sm text-gray-500 max-w-sm">
                Choose a friend from the sidebar to start chatting and catch up
